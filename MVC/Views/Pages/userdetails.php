...
<link rel='stylesheet' href='http://totnghieputt/Public/css/CDT/styleinf.css'>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center" style=" margin-top:20px;">
                    <img src="http://totnghieputt/Public/picture/avatar7.png"  class="rounded-circle" width="150">
                    <div class="mt-3">

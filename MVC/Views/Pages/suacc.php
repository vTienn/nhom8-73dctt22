    ...
    <div class="form-container">
        ...
        <form method="post" action="http://localhost/congnghephanmem/dschungchidaduyet/suacc">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txtmacc" value="<?php echo $row['MaChungChi'] ?>" readonly>
            </div>

       
            <div class="form-group">
                <label for="txttencc">Tên chứng chỉ</label>
                <input type="text" class="form-control" id="txttencc" name="txttencc" value="<?php echo $row['TenChungChi'] ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txttensv" name="txttensv" value="<?php echo $row['TenSinhVien'] ?>">
            </div>

       
            <div class="form-group">
                <label for="txtmasv">Mã sinh viên</label>
                <input type="text" class="form-control" name="txtmasv" value="<?php echo $row['MaSinhVien'] ?>" readonly>
            </div>

     
            <div class="form-group">
                <label for="txtngaycapcc">Ngày cấp chứng chỉ</label>
                <input type="date" class="form-control" id="txtngaycapcc" name="txtngaycapcc" value="<?php echo $row['NgayCapChungChi'] ?>">
            </div>
